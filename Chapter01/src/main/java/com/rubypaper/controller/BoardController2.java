...
@Controller // 어노테이션 사용 ; @Controller & @RestController
public class BoardController2 {// extend로 class 상속받지 않음
...
//	// boot가 객체를 생성해줌
//	@GetMapping("/hello")
//	public @ResponseBody String hello1(String name) { //@Controller 사용하면 @responsebody 써줘야함
